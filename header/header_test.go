...
// TestRequestHeader_Marshal test RequestHeader Marshal
func TestRequestHeader_Marshal(t *testing.T) {
	...
	assert.Equal(t, []byte{
		0x0, 0x0, 0x3, 0x41, 0x64, 0x64,
		0xa7, 0x61, 0x8a, 0x2, 0x6d, 0xa7, 0x31, 0xe5},
		header.Marshal())
}

// TestRequestHeader_Unmarshal test RequestHeader Unmarshal
...
// TestRequestHeader_ResetHeader test TestRequestHeader ResetHeader
...
// TestResponseHeader_Marshal test ResponseHeader Marshal
...
// TestResponseHeader_Unmarshal test ResponseHeader Unmarshal
